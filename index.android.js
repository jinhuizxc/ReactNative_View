            ...
            <View style={{}}>
                ...
                <View style={[styles.height160, styles.row,]}>
                    <View style={[styles.height160, styles.part_1_left,]}>
                        <Text style={[styles.font14, styles.marTop18, styles.marLeft10, styles.green]}>
                            我们约会吧
                        </Text>
                        <Text style={[styles.font12, styles.marTop14, styles.marLeft10]}>
                            恋爱家人好朋友
                        </Text>
                    ...
                    <View style={[styles.height160, styles.part_1_right,]}>
                        ...
                        <View style={[{flex: 1, flexDirection: 'row', borderTopWidth: 0.5, borderColor: '#DDD8CE'}]}>
                            ...
                            <View style={{flex: 1,}}>
                                <Text
                                    style={[styles.font14, {color: '#FF8601', marginTop: 8, marginLeft: 5}]}>名店抢购</Text>
                ...
                <View>
                    <View style={{
                        ...
                        <View style={{flex: 1}}>
                            <Text
                                style={{fontSize: 17, color: '#FF7F60', fontWeight: '900', marginLeft: 7}}>一元吃大餐</Text>
                    ...
                    <View style={{flexDirection: 'row',}}>
                        <View style={{flexDirection: 'row', flex: 1, borderRightWidth: 0.5, borderColor: '#DDD8CE'}}>
                            <View style={{flex: 1,}}>
                                <Text style={{
                                    fontSize: 17,
                                    color: '#EA6644',
                                ...
                                <Text
                                    style={{fontSize: 12, color: '#97979A', marginTop: 3, marginLeft: 7}}>烧烤6.6元起</Text>
                            </View>
                            <View style={{flex: 1}}>
                                <Image style={{width: 60, height: 55}}
                                       source={{uri: 'http://p1.meituan.net/280.0/groupop/fd8484743cbeb9c751a00e07573c3df319183.png'}}></Image>
                            </View>
                        </View>
                        <View style={{flexDirection: 'row', flex: 1}}>
                            <View style={{flex: 1}}>
                                ...
                                <Text
                                    style={{fontSize: 12, color: '#97979A', marginTop: 3, marginLeft: 7}}>选好酒店才安心</Text>
                            </View>
                            <View style={{flex: 1}}>
                                <Image style={{width: 60, height: 55}}
                                       source={{uri: 'http://p0.meituan.net/280.0/groupop/ba4422451254f23e117dedb4c6c865fc10596.jpg'}}></Image>
                            </View>
                        </View>
                        {/*0元餐来袭*/}
                    </View>
                    <View style={{flexDirection:'row'}}>
                        <View style={{flex:1,flexDirection:'row',borderRightWidth: 0.5, borderColor: '#DDD8CE'}}>
                        <View style={{flex:1}}>
