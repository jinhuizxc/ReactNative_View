...
export default class MenuList extends Component{
    ...
    renderRow(data,sectionID,rowID){
        ...
        switch (rowID) {
            case '0':
                image=require('./images/opmenu_icn_msg.png');
                break;
            case '1':
                image=require('./images/topmenu_icn_store.png');
                break;
            case '2':
                image=require('./images/topmenu_icn_member.png');
                break;
            case '3':
                image=require('./images/topmenu_icn_free.png');
                break;
            case '4':
                image=require('./images/topmenu_icn_identify.png');
                break;
            case '5':
                image=require('./images/topmenu_icn_skin.png');
                break;
            case '6':
                image=require('./images/topmenu_icn_night.png');
                break;
            case '7':
                image=require('./images/topmenu_icn_time.png');
                break;
            case '8':
                image=require('./images/topmenu_icn_clock.png');
                break;
            case '9':
                image=require('./images/topmenu_icn_vehicle.png');
                break;
            default:
        }
